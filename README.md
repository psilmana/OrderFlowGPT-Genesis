...
Delta Analysis intentionally computes delta values only. It does not perform divergence detection, trend analysis, market prediction, market bias, or trading signals. Milestone 21 introduces Volume Cluster Analysis.
